...
const SingleJob = ({ job }: { job: Job }) => {
  ...
  return (
    <>
      <div
        className="wow fadeInUp hover:shadow-two group relative overflow-hidden rounded-md bg-white shadow-one duration-300"
        data-wow-delay=".1s"
      >
        <div className="p-6 sm:p-8 md:px-6 md:py-8 lg:p-8 xl:px-5 xl:py-6 2xl:p-8">
          <h3>
            <Link
              href="/blog-details"
              className="mb-4 block text-xl capitalize font-bold text-black hover:text-primary sm:text-xl"
            >
              {title}
            </Link>
          </h3>
